(function(e) {
    e.skdslider = function(t, n) {
        ...
        e(t).wrap('<div class="skdslider" aria-label="welcome message slider"></div>');
    ...
    e.skdslider.createNav = function(t, n, r) {
        var s = '<ul class="slide-navs" aria-hidden="true">';
        ...
        if (r.showNextPrev == true) {
            var a = '<a class="prev" aria-hidden="true"></a>';
            a += '<a class="next" aria-hidden="true"></a>';
            t.append(a);
